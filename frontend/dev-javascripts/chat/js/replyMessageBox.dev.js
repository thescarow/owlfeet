...
export function openReplyMessageBox(messageId) {
  ...
  if (userMessageBox) {
    ...
    document.getElementById("activeChatInputReplyUser").textContent =
      messageUser
    ...
    if (
      ...
      document.getElementById("activeChatInputReplyUserMessage").textContent =
        messageContent
    } else {
      messageContent = ""
      if (
      ...
      document.getElementById("activeChatInputReplyUserMessage").innerHTML =
        messageContent
    }
...
export function closeReplyMessageBox() {
  document
    .getElementById("activeChatInputContainerEnableBox")
    .classList.remove("active-chat-input-container__enable-box--reply")
  document
    .getElementById("activeChatInputReplyBox")
    .classList.add("active-chat-input-reply-box--hide")
  document.getElementById("activeChatInputContainer").dataset.repliedTo = ""
  adjustMessageContainerBottomPadding()
}
