    ...
    if (
      ...
      if (
        ...
        if (
          ...
          messageContent = `${svg_videoIcon} <span>Video</span>`
        }
        if (
          userMessageBox.classList.contains(
          ...
          messageContent = `${svg_audioIcon} <span>Audio</span>`
        }
        if (
          userMessageBox.classList.contains(
          ...
          messageContent = `${svg_imageIcon} <span>Image</span>`
        }
        if (
          userMessageBox.classList.contains(
          ...
          messageContent = `${svg_youtubeIcon} <span>Youtube</span>`
        }
