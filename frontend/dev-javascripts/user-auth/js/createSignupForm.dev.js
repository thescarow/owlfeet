...
export function createSignupForm() {
  let signupFormContainer = document.createElement("div")
  signupFormContainer.classList.add("signup-form-container")
  signupFormContainer.setAttribute("id", "signupFormContainer")

  signupFormContainer.innerHTML = `
    <header>Registration Form</header>
    <div class="activity-progress activity-progress--signup" id="signupProgress">
        <div class="activity-progress__info">
            <div class="activity-progress__info-step" id="signupProgressInfoStep">STEP: 1 OF 4</div>
            <div class="activity-progress__info-step-info" id="signupProgressInfoStepInfo">Your Profile</div>
        </div>
        <div class="activity-progress__bar">
            <div class="activity-progress__bar-highlighter" id="signupProgressBarhighlighter"></div>
        </div>
    </div>
    ...
    <div class="signup-form" id="signupForm">
        ...
        <div class="signup-form-page" id="signupFormPage1">
            <div class="profile-field profile-field--signup">
                <div class="profile-field__pic" id="signupProfile" data-profile-key="">
            ...
            <div class="signup-form-page__row">
                <div class="input-field input-field--signup">
                    <label class="input-field__label" for="signupFirstName">First Name<span>*</span>
                    </label>
    
                    <input class="input-field__input" type="text" id="signupFirstName" placeholder="First Name"
                        autocomplete="off" style="text-transform:capitalize;">
    
                </div>
                <div class="input-field input-field--signup ">
                    <label class="input-field__label" for="signupLastName">Last Name</label>
                    <input class="input-field__input" type="text" id="signupLastName" placeholder="Last Name"
                        autocomplete="off" style="text-transform:capitalize;">
                </div>
            </div>
            ...
            <div class="input-field input-field--signup">
                <label class="input-field__label" for="signupEmail">Email</label>
                <input class="input-field__input" type="email" id="signupEmail" placeholder="abc@xyz.com"
                    autocomplete="off" pattern="[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-zA-Z]{2,4}$"
                    style="text-transform: lowercase;">
            </div>
    
            <div class="input-btn-field input-btn-field--signup input-btn-field--center-align">
                <div class="input-btn input-btn--next-page" id="signupNext1Btn">
                    ${svg_authNextIcon}
                </div>
            </div>
        ...
        <div class="signup-form-page" id="signupFormPage2">
            <div class="input-field input-field--signup">
                <label class="input-field__label" for="signupPassword">Set up password<span>*</span>
                </label>
                <h2 class="input-field__title">Please create a secure password including the following
                    criteria below.</h2>
                <ul class="input-field__desc-list">
                    <li class="" id="signupPasswordRule8">atleast 8 letters</li>
                    <li class="" id="signupPasswordRuleNumber">numbers</li>
                    <li class="" id="signupPasswordRuleUpper">capital letters</li>
                    <li class="" id="signupPasswordRuleSpecial">special characters</li>
                </ul>
                <div class="input-field__input-box">
                    <input class="input-field__input input-field__input--password" type="password" name="password"
                        id="signupPassword" autocomplete="off">
                    <div class="input-field__btn input-field__btn--toggle-password-view input-field__btn--password   input-field__btn--unselected"
                        id="toggleSignupPasswordBtn">
                        <div class="input-field__btn-icon input-field__btn-icon--unselected ">
                    ${svg_authPasswordHideIcon}
                           
    
                        </div>
                        <div class="input-field__btn-icon input-field__btn-icon--selected ">
                    ${svg_authPasswordShowIcon}
                           
                        </div>
                    </div>
    
                </div>
                <div class="password-strength password-strength--signup" id="signupPasswordStrength">
                    <div></div>
                    <div></div>
                    <div></div>
                    <div class="password-strength-text" id="signupPasswordStrengthText">none</div>
                </div>
    
    
            </div>
            <div class="input-field input-field--signup">
                <label class="input-field__label" for="signupConfirmPassword">Confirm password
                </label>
                <div class="input-field__input-box input-field__input-box--confirm-box">
                    <input class="input-field__input input-field__input--confirm-password" type="password"
                        name="cPassword" id="signupConfirmPassword" autocomplete="off">
                    <div class="input-field__btn input-field__btn--toggle-password-view    input-field__btn--confirm-password input-field__btn--unselected"
                        id="toggleSignupConfirmPasswordBtn">
                        <div class="input-field__btn-icon input-field__btn-icon--unselected ">
                    ${svg_authPasswordHideIcon}
                ...
                <div class="password-confirm password-confirm--signup" id="signupPasswordConfirm">
                    <div class="password-confirm-text" id="signupPasswordConfirmText"></div>
                </div>
    
            </div>
            <div class="input-btn-field input-btn-field--signup ">
                <div class="input-btn input-btn--prev-page" id="signupPrev1Btn">
                   ${svg_authPrevIcon}
                </div>
                <div class=" input-btn input-btn--next-page" id="signupNext2Btn">
                 ${svg_authNextIcon}
                </div>
            </div>
        </div>
        <div class="signup-form-page" id="signupFormPage3">
            <div class="input-field input-field--signup">
                <label class="input-field__label" for="signupUsername">Username<span
                ...
                <div class="input-field__input-box input-field__input-box--username" id="signupUsernameBox">
                    <input class="input-field__input input-field__input--username" type="text" name="username"
                        id="signupUsername" autocomplete="off">

                    <div class="input-field__input-info input-field__input-info--username">
                    
                    ${svg_authUsernameValidIcon}
                    </div>
                    <div class="input-field__btn input-field__btn--single-icon" id="signupUsernameRefreshBtn">
            ...
            <div class="input-btn-field input-btn-field--signup ">
                ...
                <div class="input-btn input-btn--prev-page" id="signupPrev2Btn">
                   ${svg_authPrevIcon}
                </div>
                <div class="input-btn input-btn--next-page" id="signupNext3Btn">
                   ${svg_authNextIcon}
                </div>
            </div>
        ...
        <div class="signup-form-page" id="signupFormPage4">
            <div class="input-field input-field--signup">
                <label class="input-field__label" for="signupGenderMale">Gender</label>
    
    
                <div class="signup-gender-btns">
    
                    <div class="signup-gender-btn">
            ...
            <div class="input-field input-field--signup">
                <label class="input-field__label" for="signupBirthday">BirthDay<span
                        class="required">*</span></label>
                <input class="input-field__input" type="date" id="signupBirthday" name="birthday"
                    autocomplete="off">
            </div>
            <div class="input-field input-field--signup">
                <label class="input-field__label" for="sigupState">Address<span class="required">*</span>
                </label>
                <select class="input-field__input input-field__input--select" name="signupState" id="signupState">
                  ${stateOptions}
                </select>
                <select class="input-field__input input-field__input--select" name="signupCity" id="signupCity">
            ...
            <div class="input-field input-field--signup">
                <label class="input-field__label" for="signupBio">Bio</label>
                <textarea class="input-field__input input-field__input--textarea" name="bio" id="signupBio"
                    cols="30" rows="10" autocomplete="off"></textarea>
            </div>
            <div class="input-btn-field input-btn-field--signup ">
                <div class="input-btn input-btn--prev-page" id="signupPrev3Btn">
                 ${svg_authPrevIcon}
                </div>
                <div class="input-btn input-btn--text input-btn--submit" id="signupSubmitBtn">Submit
                </div>
            </div>
        </div>
    </div>
  ...
  mainAccountContainer.insertAdjacentElement("beforeend", signupFormContainer)
}
