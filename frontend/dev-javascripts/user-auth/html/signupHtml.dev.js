...
<div class="signup-progress" id="signupProgress">
    <div class="signup-progress__info">
        <div class="signup-progress__info-step" id="signupProgressInfoStep">STEP: 1 OF 4</div>
        <div class="signup-progress__info-step-info" id="signupProgressInfoStepInfo">Your Profile</div>
    </div>
    <div class="signup-progress__bar">
        <div class="signup-progress__bar-highlighter" id="signupProgressBarhighlighter"></div>
    </div>
</div>
...
<div class="signup-form" id="signupForm">
    ...
    <div class="signup-form-page" id="signupFormPage1">
        <div class="signup-profile" id="signupProfileBtn" >
            <div class="signup-profile__pic" id="signupProfile" data-profile-key="" >
            ...
            <div class="signup-profile__title">Click to add profile picture</div>
        </div>
        <div class="signup-form-page__row">
            <div class="signup-input-field ">
                <label class="signup-input-field__label" for="signupFirstName">First Name<span>*</span>
                </label>

                <input class="signup-input-field__input" type="text" id="signupFirstName"
                    placeholder="First Name" autocomplete="off" style="text-transform:capitalize;">

            </div>
            <div class="signup-input-field ">
                <label class="signup-input-field__label" for="signupLastName">Last Name</label>
                <input class="signup-input-field__input" type="text" id="signupLastName" placeholder="Last Name"
        ...
        <div class="signup-input-field">
            <label class="signup-input-field__label" for="signupEmail">Email</label>
            <input class="signup-input-field__input" type="email" id="signupEmail" placeholder="abc@xyz.com"
                autocomplete="off" pattern="[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-zA-Z]{2,4}$"
                style="text-transform: lowercase;">
        </div>

        <div class="signup-btn-field signup-btn-field--center-align">
            <div class="signup-btn signup-btn--next " id="signupNext1Btn">
    ...
    <div class="signup-form-page" id="signupFormPage2">
        <div class="signup-input-field">
            <label class="signup-input-field__label" for="signupPassword">Set up password<span>*</span>
            </label>
            <h2 class="signup-input-field__title">Please create a secure password including the following
                criteria below.</h2>
            <ul class="signup-input-field__desc-list">
            ...
            <div class="signup-password-container signup-input-field__input-box">
                <input class="signup-input-field__input" type="password" name="password" id="signupPassword"
                    autocomplete="off"  placeholder="Password">
                <div class="signup-password__btn signup-password__btn--password   signup-password__btn--unselected"
                    id="toggleSignupPasswordBtn">
                    <div class="signup-password__btn-icon signup-password__btn-icon--unselected ">
                    ...
                    <div class="signup-password__btn-icon signup-password__btn-icon--selected ">
        ...
        <div class="signup-input-field">
            <label class="signup-input-field__label" for="signupConfirmPassword">Confirm password
            </label>
            <div class="signup-input-field__input-box signup-input-field__input-box--confirm-box">
                <input class="signup-input-field__input signup-input-field__input--confirm-password"
                    type="password" name="cPassword" id="signupConfirmPassword" autocomplete="off" placeholder="Confirm password">
                <div class="signup-password__btn   signup-password__btn--confirm-password signup-password__btn--unselected"
                    id="toggleSignupPasswordBtn">
                    <div class="signup-password__btn-icon signup-password__btn-icon--unselected ">
                        <svg width="100" height="70" viewBox="0 0 100 70" xmlns="http://www.w3.org/2000/svg">
                            <path
        ...
        <div class="signup-btn-field">
            <div class="signup-btn signup-btn--prev" id="signupPrev1Btn">
                <svg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div class=" signup-btn signup-btn--next" id="signupNext2Btn">
                <svg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M50 0C40.1109 0 30.444 2.93245 22.2215 8.42652C13.999 13.9206 7.59043 21.7295 3.80604 30.8658C0.0216643 40.0021 -0.968502 50.0555 0.960758 59.7545C2.89002 69.4536 7.65206 78.3627 14.6447 85.3553C21.6373 92.3479 30.5465 97.11 40.2455 99.0392C49.9445 100.969 59.9979 99.9783 69.1342 96.194C78.2705 92.4096 86.0794 86.001 91.5735 77.7785C97.0675 69.556 100 59.8891 100 50C99.989 36.7426 94.7176 24.0313 85.3432 14.6568C75.9687 5.28242 63.2574 0.0110341 50 0ZM69.3375 53.2L44.3375 74.0333C43.9173 74.3841 43.4321 74.6486 42.9096 74.8118C42.3872 74.975 41.8377 75.0338 41.2925 74.9846C40.7473 74.9355 40.2172 74.7795 39.7324 74.5254C39.2475 74.2714 38.8174 73.9244 38.4667 73.5042C38.1159 73.0839 37.8514 72.5987 37.6882 72.0763C37.525 71.5538 37.4662 71.0043 37.5154 70.4591C37.5645 69.914 37.7205 69.3838 37.9746 68.899C38.2286 68.4141 38.5756 67.9841 38.9958 67.6333L60.1542 50L38.9958 32.3667C38.5756 32.0159 38.2286 31.5858 37.9746 31.101C37.7205 30.6161 37.5645 30.086 37.5154 29.5408C37.4662 28.9957 37.525 28.4462 37.6882 27.9237C37.8514 27.4013 38.1159 26.9161 38.4667 26.4958C38.8174 26.0756 39.2475 25.7286 39.7324 25.4745C40.2172 25.2205 40.7473 25.0645 41.2925 25.0154C41.8377 24.9662 42.3872 25.0249 42.9096 25.1882C43.4321 25.3514 43.9173 25.6159 44.3375 25.9667L69.3375 46.8C69.8064 47.191 70.1837 47.6804 70.4426 48.2333C70.7014 48.7863 70.8356 49.3894 70.8356 50C70.8356 50.6106 70.7014 51.2137 70.4426 51.7667C70.1837 52.3196 69.8064 52.8089 69.3375 53.2Z" />
                </svg>
    ...
    <div class="signup-form-page" id="signupFormPage3">
        <div class="signup-input-field">
            <label class="signup-input-field__label" for="signupUsername">Username<span
            ...
            <div class="signup-input-field__input-box">
                <input class="signup-input-field__input signup-input-field__input--username" type="text"
                    name="username" id="signupUsername" autocomplete="off" placeholder="Username">
                <div class="signup-username__btn" id="signupUsernameRefreshBtn">
        ...
        <div class="signup-btn-field">
            ...
            <div class="signup-btn signup-btn--prev" id="signupPrev2Btn">
                <svg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M50 100C59.8891 100 69.556 97.0676 77.7785 91.5735C86.001 86.0794 92.4096 78.2705 96.194 69.1343C99.9783 59.998 100.969 49.9446 99.0392 40.2456C97.11 30.5465 92.3479 21.6375 85.3553 14.6449C78.3627 7.65229 69.4535 2.8902 59.7545 0.961007C50.0555 -0.968789 40.0021 0.0219082 30.8658 3.8062C21.7295 7.59059 13.9206 13.9992 8.4265 22.2217C2.9325 30.4441 0 40.111 0 50.0001C0.011 63.2575 5.2824 75.9687 14.6568 85.3432C24.0313 94.7176 36.7426 99.989 50 100ZM30.6625 46.8001L55.6625 25.9669C56.0827 25.6161 56.5679 25.3516 57.0904 25.1884C57.6128 25.0252 58.1623 24.9664 58.7075 25.0156C59.2527 25.0647 59.7828 25.2207 60.2676 25.4748C60.7525 25.7288
                </svg>
    ...
    <div class="signup-form-page" id="signupFormPage4">
        <div class="signup-input-field">
            <label class="signup-input-field__label" for="signupGenderMale">Gender</label>
        ...
        <div class="signup-input-field">
            <label class="signup-input-field__label" for="signupBirthday">BirthDay<span
                    class="required">*</span></label>
            <input class="signup-input-field__input" type="date" id="signupBirthday" name="birthday"
                autocomplete="off">
        </div>
        <div class="signup-input-field">
            <label class="signup-input-field__label" for="sigupState">Address<span class="required">*</span>
            </label>
            <select class="signup-input-field__input signup-input-field__input--select" name="signupState"
                id="signupState">
            ...
            <select class="signup-input-field__input signup-input-field__input--select" name="signupCity"
                id="signupCity">
        ...
        <div class="signup-input-field">
            <label class="signup-input-field__label" for="signupBio">Bio</label>
            <textarea class="signup-input-field__input signup-input-field__input--textarea" name="bio"
                id="signupBio" cols="30" rows="10" autocomplete="off"></textarea>
        </div>
        <div class="signup-btn-field">
            <div class="signup-btn signup-btn--prev" id="signupPrev3Btn">
                <svg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M50 100C59.8891 100 69.556 97.0676 77.7785 91.5735C86.001 86.0794 92.4096 78.2705 96.194 69.1343C99.9783 59.998 100.969 49.9446 99.0392 40.2456C97.11 30.5465 92.3479 21.6375 85.3553 14.6449C78.3627 7.65229 69.4535 2.8902 59.7545 0.961007C50.0555 -0.968789 40.0021 0.0219082 30.8658 3.8062C21.7295 7.59059 13.9206 13.9992 8.4265 22.2217C2.9325 30.4441 0 40.111 0 50.0001C0.011 63.2575 5.2824 75.9687 14.6568 85.3432C24.0313 94.7176 36.7426 99.989 50 100ZM30.6625 46.8001L55.6625 25.9669C56.0827 25.6161 56.5679 25.3516 57.0904 25.1884C57.6128 25.0252 58.1623 24.9664 58.7075 25.0156C59.2527 25.0647 59.7828 25.2207 60.2676 25.4748C60.7525 25.7288 61.1826 26.0758 61.5333 26.4959C61.8841 26.9162 62.1486 27.4014 62.3118 27.9238C62.475 28.4463 62.5338 28.9958 62.4846 29.541C62.4355 30.0861 62.2795 30.6163 62.0254 31.1011C61.7714 31.586 61.4244 32.016 61.0042 32.3668L39.8458 50.0001L61.0042 67.6334C61.4244 67.9842 61.7714 68.4143 62.0254 68.8991C62.2795 69.384 62.4355 69.9141 62.4846 70.4593C62.5338 71.0044 62.475 71.5539 62.3118 72.0764C62.1486 72.5988 61.8841 73.084 61.5333 73.5043C61.1826 73.9245 60.7525 74.2715 60.2676 74.5256C59.7828 74.7796 59.2527 74.9356 58.7075 74.9847C58.1623 75.0339 57.6128 74.9752 57.0904 74.8119C56.5679 74.6487 56.0827 74.3842 55.6625 74.0334L30.6625 53.2001C30.1936 52.8091 29.8163 52.3197 29.5574 51.7668C29.2986 51.2138 29.1644 50.6107 29.1644 50.0001C29.1644 49.3895 29.2986 48.7864 29.5574 48.2334C29.8163 47.6805 30.1936 47.1912 30.6625 46.8001Z" />
                </svg>
            </div>
            <div class="signup-btn signup-btn--submit" id="signupSubmitBtn">Submit
            </div>
        </div>
    </div>
</div>
